...
--
-- Host: localhost
-- Generation Time: Sep 01, 2016 at 08:02 PM
...
(8, 1, '127.0.0.1', '2016-09-01 23:21:34', 'login', 'security', 'Login correcto.', 's:46:"El usuario admin se ha logueado correctamente.";'),
(9, 1, '127.0.0.1', '2016-09-01 23:28:23', 'login', 'security', 'Login correcto.', 's:46:"El usuario admin se ha logueado correctamente.";'),
(10, 1, '127.0.0.1', '2016-09-01 23:58:39', 'login', 'security', 'Login correcto.', 's:46:"El usuario admin se ha logueado correctamente.";'),
(11, 1, '127.0.0.1', '2016-09-01 23:58:45', 'login', 'security', 'Login correcto.', 's:46:"El usuario admin se ha logueado correctamente.";');
...
('admin', '1', 1472757222),
('manejo-estados', '1', 1472773946),
('manejo-logs', '1', 1472757018),
('manejo-organigrama', '1', 1472772792),
('manejo-prioridades', '1', 1472773132),
...
('manejo-estados', 2, 'manejo-estados en backend', NULL, NULL, 1472773938, 1472773938),
('manejo-logs', 2, 'Visualizar y manejar los logs.', NULL, NULL, 1472756957, 1472756957),
('manejo-organigrama', 2, 'Puede manejar el organigram en el backend.', NULL, NULL, 1472772782, 1472772782),
('manejo-prioridades', 2, 'Manejo de prioridades en el backend.', NULL, NULL, 1472773124, 1472773124),
...
(1, 'Alan', '', '', 'd41d8cd98f00b204e9800998ecf8427e', '', '', '', 'Pacific/Kiritimati'),
...
(1, '7LGh3m7sF1jYnSJlP-nQn-BTTMHd-Xcs', 1472717915, 0);
...
(1, 'admin', 'admin@mail.mail', '$2y$10$7qrfWMJZ7lpjPDv86jOxYOTtteaJa2r.zZh07DTZHRGJDYzuI7Jie', 'xXlDLt3vcP5oP1p7aKFbFz91BbplFb3n', 1472718067, NULL, NULL, '127.0.0.1', 1472717915, 1472717915, 0),
(2, 'marc', 'marc@marc.email', '$2y$12$CXH3V73Y6j3JK/x4pYLDKOjRUwYTdG8shQLVTV5lcdKDTJGIddZVO', 'nRLTQFruYj0awSnG7lPP-6Y8gwYCSzPD', 1472763895, NULL, NULL, '127.0.0.1', 1472763896, 1472763896, 0);
